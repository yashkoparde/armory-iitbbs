        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center gap-4">
              <a href="https://github.com/yashkoparde" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-lg bg-arctic/5 hover:bg-forsythia hover:text-oceanic transition-all text-mystic/55" aria-label="Github link">
              ...
              <a href="https://x.com/yshkoparde" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-lg bg-arctic/5 hover:bg-forsythia hover:text-oceanic transition-all text-mystic/55" aria-label="Twitter link">
                <svg className="h-4.5 w-4.5 fill-current" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://yashkoparde.vercel.app" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-lg bg-arctic/5 hover:bg-forsythia hover:text-oceanic transition-all text-mystic/55" aria-label="Portfolio link">
                <svg className="h-4.5 w-4.5 fill-none stroke-current" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="relative border-t border-arctic/5 pt-12 text-center overflow-hidden select-none">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-mystic/40 relative z-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-[10px]">Orchestrated by <a href="https://yashkoparde.vercel.app" target="_blank" rel="noopener noreferrer" className="text-forsythia hover:text-saffron transition-colors underline decoration-dotted font-semibold">Yash Koparde</a></span>
            </div>
          </div>
        </div>
      </div>
